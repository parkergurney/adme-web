...
export default function QueryPage() {
	...
	/*const handleBatchSubmit = async () => {
		...
		try {
			...
			setIsLoading(false)
			console.log(`/projects/results?projectId=${currentProject.id}&resultId=${firstResultId}`)
	...
	const handleBatchSubmit = () => {
		...
		router.push('/projects/results?projectId=p_1762814827948&resultId=r_1762916940404_0')
